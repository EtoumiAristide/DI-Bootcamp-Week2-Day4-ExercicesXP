 ...
 * @description DI-Bootcamp Week2 Day4 ExercicesXP Exercice 4: Shopping List
 * @param const stock
 * @param const prices
 * @param shoppingList
 */
...
function myBill() {
    ...
    let totalPrice = 0;
    for (const shoppingListItem of shoppingList) {
        if (checkStock(shoppingListItem)) {
            totalPrice += getPrice(shoppingListItem)
        }
    }
    return totalPrice;
}
...
/**
 * Recherche si l'article est en stock ou pas
 * @param article 
 * @returns true si l'article est en stock et false sinon
*/
...
console.log("the total price of your shoppingList is " + myBill());
